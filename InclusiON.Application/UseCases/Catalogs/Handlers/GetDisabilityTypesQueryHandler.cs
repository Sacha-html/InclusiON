...
namespace InclusiON.Application.UseCases.Catalogs.Handlers
{
        ...
        : IQueryHandler<GetDisabilityTypesQuery, ApiResponse<List<CatalogItemResponse>>>
    {
        ...
        {
            if (_cache.TryGetValue(CatalogCacheKeys.DisabilityTypes, out List<CatalogItemResponse>? cached) && cached is not null)
            ...
            _cache.Set(CatalogCacheKeys.DisabilityTypes, response, new MemoryCacheEntryOptions()
