...
namespace InclusiON.Application.UseCases.Catalogs.Handlers
{
        ...
        : IQueryHandler<GetAutonomyLevelsQuery, ApiResponse<List<AutonomyLevelResponse>>>
    {
        ...
        {
            if (_cache.TryGetValue(CatalogCacheKeys.AutonomyLevels, out List<AutonomyLevelResponse>? cached) && cached is not null)
            ...
            _cache.Set(CatalogCacheKeys.AutonomyLevels, response, new MemoryCacheEntryOptions()
