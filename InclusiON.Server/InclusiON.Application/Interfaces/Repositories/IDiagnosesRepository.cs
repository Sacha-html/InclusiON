...
namespace InclusiON.Application.Interfaces.Repositories
{
    public interface IDiagnosesRepository
    {
        ...
        Task<PagedResponse<Diagnosis>> GetPagedByPersonIdAsync(Guid personId, int page, int pageSize, bool? isActive = null, CancellationToken cancellationToken = default);
