...
namespace InclusiON.Tests.Unit.Handlers.Activities
{
    public class ActivityQueryHandlersTests
    {
        ...
        public async Task GetActivities_ReturnsPagedResult()
        {
            ...
            var handler = new GetActivitiesQueryHandler(_activitiesRepo);
        ...
        public async Task GetActivities_EmptyResult_ReturnsZeroRecords()
        {
            ...
            var query = new GetActivitiesQuery(ProfId, null, null, null, null, null, null, 1, 10);
            var result = await new GetActivitiesQueryHandler(_activitiesRepo).HandleAsync(query, default);
        ...
        public async Task GetActivityById_NotFound_ReturnsNotFound()
        {
            ...
            var result = await new GetActivityByIdQueryHandler(_activitiesRepo)
        ...
        public async Task GetPersonActivityAssignments_ReturnsMappedList()
        {
            ...
            var handler = new GetPersonActivityAssignmentsQueryHandler(_assignRepo);
            var result = await handler.HandleAsync(
                new GetPersonActivityAssignmentsQuery(PersonId, Guid.NewGuid()), default);
        ...
        public async Task GetPersonActivityAssignments_NoAssignments_ReturnsEmptyList()
        {
            ...
            var result = await new GetPersonActivityAssignmentsQueryHandler(_assignRepo)
                .HandleAsync(new GetPersonActivityAssignmentsQuery(PersonId, Guid.NewGuid()), default);
