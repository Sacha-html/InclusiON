...
| IN-86 | Timeline de diagnósticos en perfil de persona | → Movido a Sprint 5 | → Movido a Sprint 5 | 🔄 |
...
| IN-90 | Radar chart de habilidades | → Movido a Sprint 5 | → Movido a Sprint 5 | 🔄 |
| IN-91 | Dashboard familiar | → Movido a Sprint 5 | → Movido a Sprint 5 | 🔄 |
| IN-92 | Portal familia con progreso completo | → Movido a Sprint 5 | → Movido a Sprint 5 | 🔄 |
...
| Total tareas | 24 |
| Completadas | 15 |
| Movidas a Sprint 5 | 4 |
| Pendientes | 5 |

---

## Pendientes a Sprint 7 (Onboarding)

- IN-98, IN-99, IN-100, IN-101, IN-102
